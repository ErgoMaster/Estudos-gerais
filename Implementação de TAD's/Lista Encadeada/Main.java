public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(lista); // Lista: 9 - 10 - 5
        System.out.print("\n");
        ...
        System.out.println(lista); // Lista: 9 - 10 - 5 - 4 - 8 - 12
        System.out.print("\n");
        ...
        try {
            ...
            System.out.println(lista); // Lista: 9 - 5 - 4 - 12 
        ...
        System.out.println(lista1); // Lista1 : 1 - 2 - 3

        lista1.atribuir(lista);

        System.out.println("Lista1 depois da atribuição: ");
        System.out.println(lista1); // Lista1: 9 - 5 - 4 - 12
    }
}
